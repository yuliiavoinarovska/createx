# Багатосторінковий сайт Createx
...
## Работа с html
html- сторінки поділені на окремі секції для зручності їх повторного використання та збираються плагіном __gulp-file-include__. 

Всі сторінки перевірені на валідність та відповідають стандартам валідної верстки.


## Работа с CSS
Для написання стилі використано препроцессор  __sass__ у синтаксісі __scss__.

Створено css-змінні для кольорів проекту та основного шрифту.

Для стилізації кнопок та заголовків створено класи з модифікаторами та винесено в окремі файли.
